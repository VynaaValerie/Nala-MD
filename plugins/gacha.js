let handler = async (m, { conn, command, args, text, usedPrefix }) => {
    let bruh = `Tulis ${usedPrefix}open <crate name> < 1 | 10 | 100 | 1000 >\n\nContoh penggunaan: *${usedPrefix}open common 10*\n\nlist crate:\n*pet*\n*boxs*\n*cupon*\n*common*\n*uncommon*\n*mythic*\n*legendary*\n*gardenboxs*`
    let _lmao = args[0]
        ...
        case 'common':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _cm = `${Math.floor(Math.random() * 2)}`.trim()
                    let _cc = `${Math.floor(Math.random() * 0)}`.trim()
                    let _cp = `${Math.floor(Math.random() * 1)}`.trim()
                    let _ce = `${Math.floor(Math.random() * 50)}`.trim()
...
`.trim()
                ...
                case '10':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _cm1 = `${Math.floor(Math.random() * 20)}`.trim()
                    let _cc1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _cp1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ce1 = `${Math.floor(Math.random() * 50)}`.trim()
                    let _cu1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let cm1 = (_cm1 * 1)
                    let cc1 = (_cc1 * 1)
                    let cp1 = (_cp1 * 1)
                    let ce1 = (_ce1 * 1)
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _cm2 = `${Math.floor(Math.random() * 200)}`.trim()
                    let _cc2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _cp2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ce2 = `${Math.floor(Math.random() * 500)}`.trim()
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _cm3 = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _cc3 = `${Math.floor(Math.random() * 20)}`.trim()
                    let _cp3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ce3 = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _cu3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let cm3 = (_cm3 * 1)
                    let cc3 = (_cc3 * 1)
                    let cp3 = (_cp3 * 1)
                    let ce3 = (_ce3 * 1)
        ...
        case 'uncommon':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _ue = `${Math.floor(Math.random() * 65)}`.trim()
                    let _um = `${Math.floor(Math.random() * 4)}`.trim()
                    let _up = `${Math.floor(Math.random() * 0)}`.trim()
                    let _umc = `${Math.floor(Math.random() * 1)}`.trim()
                    let _uu = `${Math.floor(Math.random() * 0)}`.trim()
                    let _uc = `${Math.floor(Math.random() * 0)}`.trim()
                    let ud = (_ud * 1)
                    let ue = (_ue * 1)
                    let um = (_um * 1)
                    let up = (_up * 1)
...
`.trim()
                ...
                case '10':
                    ...
                    let _ue1 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _um1 = `${Math.floor(Math.random() * 40)}`.trim()
                    let _up1 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _umc1 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _uu1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _uc1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let ud1 = (_ud1 * 1)
                    let ue1 = (_ue1 * 1)
                    let um1 = (_um1 * 1)
                    let up1 = (_up1 * 1)
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _ud2 = `${Math.floor(Math.random() * 14)}`.trim()
                    let _ue2 = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _um2 = `${Math.floor(Math.random() * 300)}`.trim()
                    let _up2 = `${Math.floor(Math.random() * 30)}`.trim()
                    let _umc2 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _uu2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _uc2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let ud2 = (_ud2 * 1)
                    let ue2 = (_ue2 * 1)
                    let um2 = (_um2 * 1)
                    let up2 = (_up2 * 1)
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _ud3 = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _ue3 = `${Math.floor(Math.random() * 40000)}`.trim()
                    let _um3 = `${Math.floor(Math.random() * 2500)}`.trim()
                    let _up3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _umc3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _uu3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _uc3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let ud3 = (_ud3 * 1)
                    let ue3 = (_ue3 * 1)
                    let um3 = (_um3 * 1)
                    let up3 = (_up3 * 1)
        ...
        case 'mythic':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm = `${Math.floor(Math.random() * 3)}`.trim()
                    let _mmm = `${pickRandom(['0', '0', '1', '0'])}`.trim()
                    let _me = `${Math.floor(Math.random() * 200)}`.trim()
                    let _mp = `${Math.floor(Math.random() * 10)}`.trim()
                    let _mu = `${Math.floor(Math.random() * 4)}`.trim()
                    let _mc = `${Math.floor(Math.random() * 0)}`.trim()
...
`.trim()
                ...
                case '10':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm1 = `${Math.floor(Math.random() * 15)}`.trim()
                    let _mmm1 = `${Math.floor(Math.random() * 4)}`.trim()
                    let _me1 = `${Math.floor(Math.random() * 2000)}`.trim()
                    let _mp1 = `${Math.floor(Math.random() * 70)}`.trim()
                    let _mu1 = `${Math.floor(Math.random() * 20)}`.trim()
                    let _mc1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ml1 = `${Math.floor(Math.random() * 1)}`.trim()
                    let _md1 = `${Math.floor(Math.random() * 30)}`.trim()
                    let mm1 = (_mm1 * 1)
                    let mmm1 = (_mmm1 * 1)
                    let me1 = (_me1 * 1)
                    let mp1 = (_mp1 * 1)
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm2 = `${Math.floor(Math.random() * 150)}`.trim()
                    let _mmm2 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _me2 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _mp2 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _mu2 = `${Math.floor(Math.random() * 50)}`.trim()
                    let _mc2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ml2 = `${Math.floor(Math.random() * 6)}`.trim()
                    let _md2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let mm2 = (_mm2 * 1)
                    let mmm2 = (_mmm2 * 1)
                    let me2 = (_me2 * 1)
                    let mp2 = (_mp2 * 1)
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm3 = `${Math.floor(Math.random() * 1500)}`.trim()
                    let _mmm3 = `${Math.floor(Math.random() * 50)}`.trim()
                    let _me3 = `${Math.floor(Math.random() * 50000)}`.trim()
                    let _mp3 = `${Math.floor(Math.random() * 200)}`.trim()
                    let _mu3 = `${Math.floor(Math.random() * 90)}`.trim()
                    let _mc3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ml3 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _md3 = `${Math.floor(Math.random() * 30)}`.trim()
                    let mm3 = (_mm3 * 1)
                    let mmm3 = (_mmm3 * 1)
                    let me3 = (_me3 * 1)
                    let mp3 = (_mp3 * 1)
        ...
        case 'boxs':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mmz = `${Math.floor(Math.random() * 25)}`.trim()
                    let _bbbz = `${pickRandom(['0', '0', '1', '0'])}`.trim()
                    let _mez = `${Math.floor(Math.random() * 200)}`.trim()
                    let _mpz = `${Math.floor(Math.random() * 10)}`.trim()
                    let _lmz = `${Math.floor(Math.random() * 3)}`.trim()
                    let _hmz = `${Math.floor(Math.random() * 10)}`.trim()
                    let _mlz = `${Math.floor(Math.random() * 10)}`.trim()
                    let _ebz = `${Math.floor(Math.random() * 10)}`.trim()
                    let mmz = (_mmz * 1)
                    let bbbz = (_bbbz * 1)
                    let mez = (_mez * 1)
                    let mpz = (_mpz * 1)
...
`.trim()
                ...
                case '10': 
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mme= `${Math.floor(Math.random() * 500)}`.trim()
                    let _bbbe = `${Math.floor(Math.random() * 4)}`.trim()
                    let _mee = `${Math.floor(Math.random() * 2000)}`.trim()
                    let _mpe = `${Math.floor(Math.random() * 100)}`.trim()
                    let _lme = `${Math.floor(Math.random() * 30)}`.trim()
                    let _hme = `${Math.floor(Math.random() * 100)}`.trim()
                    let _mle = `${Math.floor(Math.random() * 100)}`.trim()
                    let _ebe = `${Math.floor(Math.random() * 100)}`.trim()
                    let mme = (_mme * 1)
                    let bbbe = (_bbbe * 1)
                    let mee = (_mee * 1)
                    let mpe = (_mpe * 1)
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mmk = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _bbbk = `${Math.floor(Math.random() * 10)}`.trim()
                    let _mek = `${Math.floor(Math.random() * 20000)}`.trim()
                    let _mpk = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _lmk = `${Math.floor(Math.random() * 300)}`.trim()
                    let _hmk = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _mlk = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _ebk = `${Math.floor(Math.random() * 1000)}`.trim()
                    let mmk = (_mmk * 1)
                    let bbbk = (_bbbk * 1)
                    let mek = (_mek * 1)
                    let mpk = (_mpk * 1)
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mmo = `${Math.floor(Math.random() * 50000)}`.trim()
                    let _bbbo= `${Math.floor(Math.random() * 50)}`.trim()
                    let _meo = `${Math.floor(Math.random() * 200000)}`.trim()
                    let _mpo = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _lmo = `${Math.floor(Math.random() * 30000)}`.trim()
                    let _hmo = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _mlo = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _ebo = `${Math.floor(Math.random() * 10000)}`.trim()
                    let mmo = (_mmo * 1)
                    let bbbo = (_bbbo * 1)
                    let meo = (_meo * 1)
                    let mpo = (_mpo * 1)
...
`.trim()
            	...
            	case '100':
                  case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lksb = `${Math.floor(Math.random() * 30000)}`.trim()
                    let _lkdb = `${Math.floor(Math.random() * 30000)}`.trim()
                    let _lkeb = `${Math.floor(Math.random() * 30000)}`.trim()
                    let _lkrb = `${Math.floor(Math.random() * 30000)}`.trim()
                    let _lkyb = `${Math.floor(Math.random() * 30000)}`.trim()
                    let lksb = (_lksb * 1)
                    let lkrb = (_lkrb * 1)
                    let lkeb = (_lkeb * 1)
                    let lkdb = (_lkdb* 1)
...
`.trim()
    			...
    			case '1000':
                 case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lksk = `${Math.floor(Math.random() * 300000)}`.trim()
                    let _lkdk = `${Math.floor(Math.random() * 300000)}`.trim()
                    let _lkek = `${Math.floor(Math.random() * 300000)}`.trim()
                    let _lkrk = `${Math.floor(Math.random() * 300000)}`.trim()
                    let _lkyk = `${Math.floor(Math.random() * 30000)}`.trim()
                    let lksk = (_lksk * 1)
                    let lkrk = (_lkrk * 1)
                    let lkek = (_lkek * 1)
                    let lkdk = (_lkdk * 1)
        ...
        case 'legendary':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm = `${Math.floor(Math.random() * 60)}`.trim()
                    let _le = `${Math.floor(Math.random() * 500)}`.trim()
                    let _lp = `${Math.floor(Math.random() * 30)}`.trim()
                    let _lu = `${Math.floor(Math.random() * 2)}`.trim()
                    let _lc = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ll = `${pickRandom(['0', '0', '1', '0'])}`.trim()
                    let _lpp = `${pickRandom(['0', '1', '0'])}`.trim()
                    let _ld = `${Math.floor(Math.random() * 10)}`.trim()
...
`.trim()  
                ...
                case '10':
                    ...
                    let _le1 = `${Math.floor(Math.random() * 3000)}`.trim()
                    let _lp1 = `${Math.floor(Math.random() * 150)}`.trim()
                    let _lu1 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _lc1 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ll1 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _lpp1 = `${Math.floor(Math.random() * 6)}`.trim()
                    let _ld1 = `${Math.floor(Math.random() * 100)}`.trim()
...
`.trim()  
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm2 = `${Math.floor(Math.random() * 2000)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 20000)}`.trim()
                    let _lp2 = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _lu2 = `${Math.floor(Math.random() * 80)}`.trim()
                    let _lc2 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ll2 = `${Math.floor(Math.random() * 11)}`.trim()
                    let _lpp2 = `${Math.floor(Math.random() * 51)}`.trim()
                    let _ld2 = `${Math.floor(Math.random() * 400)}`.trim()
...
`.trim()  
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm3 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 100000)}`.trim()
                    let _lp3 = `${Math.floor(Math.random() * 8000)}`.trim()
                    let _lu3 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _lc3 = `${Math.floor(Math.random() * 0)}`.trim()
                    let _ll3 = `${Math.floor(Math.random() * 51)}`.trim()
                    let _lpp3 = `${Math.floor(Math.random() * 222)}`.trim()
                    let _ld3 = `${Math.floor(Math.random() * 1000)}`.trim()
...
`.trim()  
        ...
        case 'pet':
            ...
            let randpet = `${pickRandom(['Anda kurang beruntung', 'Coba buka lagi lain kali, karena gk dapet pet', 'kasian gk dapet pet', 'Maaf anda gak dapet pet', 'Belum beruntung'])}`.trim()
