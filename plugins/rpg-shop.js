...
const Bapel = 3
const Sapel = 3
const Bbibitpisang = 0.5
const Sbibitpisang = 0.5
const Bbibitmangga = 0.5
const Sbibitmangga = 0.5
const Bbibitjeruk = 0.5
const Sbibitjeruk = 0.5
const Bbibitanggur = 0.5
const Sbibitanggur = 0.5
const Bbibitapel = 0.5
const Sbibitapel = 0.5
const Bgardenboxs = 10
const Sgardenboc = 5
const Bberlian = 25
const Sberlian = 20
const Bemasbatang = 15
const Semasbatang = 10
const Bemasbiasa = 10
const Semasbiasa = 8
const Bphonix = 3000
const Sphonix = 1500
...
const Bmakananpet = 5
const Smakananpet = 5
const Bmakananphonix = 30
const Smakananphonix = 30
const Bmakanangriffin = 20
const Smakanangriffin = 20
const Bmakanannaga = 15
const Smakanannaga = 15
const Bmakanankyubi = 10
const Smakanankyubi = 10
const Bmakanancentaur = 10
const Smakanancentaur = 10
const Bhealtmonster = 10
const Bpet = 100
const Spet = 50
const Blimit = 1
const Slimit = 1
...
let handler  = async (m, { conn, command, args, usedPrefix, owner }) => {
    ...
    const armor = (_armor == 0 ? 100 : '' || _armor == 1 ? 40 : '' || _armor == 2 ? 99999 : '' || _armor == 3 ? 149999 : '' || _armor == 4 ? 299999 : '')
...
function beliItem(itemName, buyPrice, sellPrice, count, m) {
    const userMoney = global.db.data.users[m.sender].money;

    if (userMoney >= buyPrice * count) {
        global.db.data.users[m.sender][itemName] += count;
        global.db.data.users[m.sender].money -= buyPrice * count;
        conn.reply(m.chat, `Berhasil membeli ${count} ${itemName} dengan harga ${buyPrice * count} money`, m);
    } else {
        conn.reply(m.chat, `Uang Anda tidak mencukupi untuk membeli ${count} ${itemName} dengan harga ${buyPrice * count} money`, m);
    }
}